...
-   for the probability density curve, to sort it by values (either mean or median), otherwise will miss the pattern à which is like 3 clusters (800 to 600, 600 to 400, 400 and below), every school has good students but for relatively poorer schools, their poorest performing students fair worse than those in better schools.
