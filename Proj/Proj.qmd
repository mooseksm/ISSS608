...
## Detailed view of rainfall over the years

```{r,fig.height=6}
p1 <- ggplot(rainfall_data_month,
...
p12 <- ggplot(rainfall_data_month,
             aes(y=monthly_rainfall,
                 x = as.factor(month),
                 fill = as.factor(year))) +
  geom_bar(stat = "identity")+
...
p19 <- ggplot() +
  geom_line(data = temp_month,
            aes(x = year,
              ...
              facet_wrap(~month,scales = "free_x")+
              labs(axis.text.x=element_blank(),
                   title = "Highest max temperature by month from 2014 to 2023")+
              xlab("")+
              ylab("Degrees (°C)")+
              scale_color_discrete(name = "Month")+
              theme_tufte(base_family = "Helvetica")+ theme(axis.text.x = element_text(angle = 90, hjust = 1, vjust = 1))
...
p20 <- ggplot() +
  geom_line(data = temp_month,
            aes(x = year,
              ...
              facet_wrap(~month,scales = "free_x")+
              labs(axis.text.x=element_blank(),
                   title = "Lowest min temperature by month from 2014 to 2023")+
              xlab("")+
              ylab("Degrees (°C)")+
              scale_color_discrete(name = "Month")+
              theme_tufte(base_family = "Helvetica")+ theme(axis.text.x = element_text(angle = 90, hjust = 1, vjust = 1))
