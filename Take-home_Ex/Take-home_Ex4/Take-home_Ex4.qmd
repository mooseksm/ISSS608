...
test <- ggplot(historical_rainfall_month,
...
::: panel-tabset
## Mean Rainfall across months

**The hypothesis is as follows:**

*H~0~: There is no difference between mean rainfall across months.*

*H~1~: There is a difference between mean rainfall across months.*
...
As the p-values of the test above are \< 0.05, we reject the null hypothesis at alpha = 0.05. There is sufficient evidence to indicate that there is a difference in the rainfall across months.

## Mean Daily Rainfall across months

**The hypothesis is as follows:**

*H~0~: There is no difference between mean daily rainfall across months.*

*H~1~: There is a difference between mean daily rainfall across months.*
...
test2 <- ggplot(historical_temp_month,
       aes(y = median_mean_temp,
           x = month,
           fill = year)) +
  geom_bar(stat = "identity")+
...
Based on observation, it seems like median daily mean temperature does not differ signicantly across months from 2014 to 2023.

## Median Daily Maximum Temperature

```{r,fig.width=15,fig.height=12}
test3 <- ggplot(historical_temp_month,
       aes(y = median_max_temp,
           x = month,
           fill = year)) +
  geom_bar(stat = "identity")+
...
Based on observation, it seems like median daily max temperature is not significantly different across months over the years from 2014 to 2023.

## Median Daily Minimum Temperature

```{r,fig.width=15,fig.height=12}
test4 <- ggplot(historical_temp_month,
       aes(y = median_min_temp,
           x = month,
           fill = year)) +
  geom_bar(stat = "identity")+
...
Based on observation, it seems like median daily minimum temperature significantly differs across months over the years from 2014 to 2023.
:::
...
*H~0~: There is no difference between mean daily mean temperature across months.*

*H~1~: There is a difference between mean daily mean temperature across months.*
...
As the p-values of the test above are \< 0.05, we reject the null hypothesis at alpha = 0.05. There is sufficient evidence to indicate that there is a difference in the mean daily mean temperature across months.

## Daily Max Temperature

**The hypothesis is as follows:**

*H~0~: There is no difference between mean daily max temperature across months.*

*H~1~: There is a difference between mean daily max temperature across months.*
...
As the p-values of the test above are \< 0.05, we reject the null hypothesis at alpha = 0.05. There is sufficient evidence to indicate that there is a difference in the mean daily max temperature across months.
...
As the p-values of the test above are \< 0.05, we reject the null hypothesis at alpha = 0.05. There is sufficient evidence to indicate that there is a difference in the mean daily min temperature across months.
:::
