...
The plot above shows p-values of pairwise test that have p-values \< 0.05 and for which the null hypothesis will be rejected at alpha = 0.05. There is sufficient evidence to indicate that there is a difference in the median daily mean temperature for stations:
...
**Overall, this indicates that the differences in median daily mean temperature across stations is generally statistically significant. This suggests that different regions of Singapore are hotter/cooler.**
